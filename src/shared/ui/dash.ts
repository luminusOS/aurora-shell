...
export class AuroraDash extends Dash {
  ...
  override _init(params: AuroraDashParams = {}): void {
    ...
    this._fixedItems = new DashFixedItems(
      this,
      this._dashInternals,
      params.showTrash ?? false,
      params.showExternalStorage ?? false,
      () => {
        this._queueRedisplay();
  ...
  private _onDashContainerDestroyed(): void {
    ...
    delete (this as unknown as { _dashContainer?: St.Widget })._dashContainer;
  }
