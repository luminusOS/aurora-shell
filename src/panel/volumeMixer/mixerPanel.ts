...
export const VolumeMixerPanel = GObject.registerClass(
  {
    Properties: {
  ...
  class VolumeMixerPanel extends St.BoxLayout {
    ...
    override _init(context?: ExtensionContext | Partial<St.BoxLayout.ConstructorProps>): void {
      ...
      this._list = new VolumeMixerList(context as ExtensionContext);
...
export type VolumeMixerPanel = InstanceType<typeof VolumeMixerPanel>;
