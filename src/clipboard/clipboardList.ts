...
export const ClipboardList = GObject.registerClass(
  class ClipboardList extends St.BoxLayout {
    ...
    private _addItem(entry: ClipboardEntry): void {
      const item = new ClipboardItem(entry, this._callbacks);
...
export type ClipboardList = InstanceType<typeof ClipboardList>;
